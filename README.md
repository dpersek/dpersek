...
**Building practical AI systems from a farm in North Carolina.**
...
- **See what I am building:** [PersekOS](https://dustinpersek.com/persek-os.html), my local home for work that would otherwise disappear into chats, notes, reminders, and browser tabs.
- **See what I have shipped:** [merged open-source contributions](#open-source) across AI, developer tooling, accessibility, reliability, and local-first software.
- **Read the unlikely backstory:** [from corporate systems to a North Carolina farm](https://dustinpersek.com/work-background.html).
- **Compare notes:** [X](https://x.com/dpersek) is the best place to reach me.
